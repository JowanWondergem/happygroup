  <ul class="v_list side_menu bg_gr_yellow rounded-corners shadow">
      ...
      <li <?php  if(strpos($_SERVER['REQUEST_URI'],'type=map') || strpos($_SERVER['REQUEST_URI'],'partners.php')) echo 'class="active"';?>><a href="index.php?type=map"><?php echo $l_menu_search; ?></a></li>
