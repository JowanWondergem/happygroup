	...
	<div id="page-heading">
         ...
         <div class="navbar">
          <div class="navbar-inner">
            <a class="brand" href="#"><?php echo $l_areas_title_grid ?></a>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"  width="30"><a href=""><?php echo $l_form_code ?></a></th>
				...
				<tr>
					<td><input value="<?php echo $area['id']; ?>"  type="checkbox"/></td>
                   
					<td><?php echo $area['code']; ?></td>
                    <td><?php echo $area['country']; ?></td>
                    <td><?php echo $area['area']; ?></td>
                    
                   
					<!--<td class="options-width">
				<a href="partners_edit_step1.php?id=<?php echo $area['id']; ?>" title="Edit Info" class="icon-1 info-tooltip"></a>
					<a href="javascript:deleteCountry(<?php echo $area['id']; ?>)" title="Delete" class="icon-2 info-tooltip"></a>
...
function deleteCountry(id_partner)
					{
