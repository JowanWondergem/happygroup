	...
	<div id="page-heading">
        ...
        <div class="navbar">
          <div class="navbar-inner">
            <a class="brand" href="#"><?php echo $l_countries_title_grid ?></a>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
                ...
                include_once('../bz/Country.php'); 
    	 		$Countries = Country::getAllCountries($_SESSION['id_lan']);  
				...
				<tr>
					<td><input value="<?php echo $country['id']; ?>"  type="checkbox"/></td>
                   
					<td><?php echo $country['code_2_letter']; ?></td>
                    <td><?php echo $country['text_normal']; ?></td>
                    
                   
					<!--<td class="options-width">
						<a href="attr_countries_edit_step1.php?id=<?php echo $country['id']; ?>" title="Edit Info" class="icon-1 info-tooltip"></a>
					</td>-->
				</tr>
