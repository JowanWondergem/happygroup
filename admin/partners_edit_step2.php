...
<tr>
	...
	<td>
        ...
        <?php
			...
			echo UploadImage($partner_id,'small_temp',1,'img_s','partners',175,175,'Image Logo',1);
			
			echo UploadImage($partner_id,'big_temp',2,'img_b','partners',500,370,'Image Large',1);*/
...
<input type="file" name="photoimg" id="photoimg" class="form-file btn" />

</form>
<div id='preview'>
<?php if($Partner['img_s']!=""): ?>
<a href="../media/partners/<?php echo $Partner['img_s'] ?>" rel="prettyPhoto[gallery1]" >
...
<a href="../media/partners/<?php echo $Partner['img_b'] ?>" rel="prettyPhoto[gallery1]" >
