...
<div id="page-heading"><h1><a href="web_contacts_grid.php"><?php echo $l_contact_title_grid ?></a> » <?php echo $l_contact_edit?></h1></div>
...
<tr>
	...
	<td>
		...
		<!--  end step-holder -->
         ...
         <?php include_once('../bz/Contact.php');		
		...
		<tr>
			...
			<td>
                 <select id="active"  class="">
                    <option value="1"   <?php if($Contact['active']==1){ echo 'selected="selected" '; } ?>  >YES</option>
                    <option value="0"   <?php if($Contact['active']==0){ echo 'selected="selected" '; } ?> >NO</option>
         ...
         <tr>
			...
			<td>	
		<input id="name" type="text" value="<?php echo $Contact['name'] ?>" class="inp-form validate[required]"  />
		</td>
		<td></td>
		</tr>
         <tr>
			...
			<td>	
		<input id="place" type="text" value="<?php echo $Contact['place'] ?>" class="inp-form validate[required]"  />
		</td>
		<td></td>
		</tr>
         <tr>
			...
			<td>	
		<input id="address" type="text" value="<?php echo $Contact['address'] ?>" class="inp-form"  />
		</td>
		<td></td>
		</tr>
         <tr>
			...
			<td>	
		<input id="zip_code" type="text" value="<?php echo $Contact['zip_code'] ?>" class="inp-form "  />
		</td>
		<td></td>
		</tr>
        <tr>
			...
			<td>	
		<input id="telephone" type="text" value="<?php echo $Contact['telephone'] ?>" class="inp-form validate[required]"  />
		</td>
		<td></td>
		</tr>
         ...
         <tr>
			...
			<td>	
		<input id="fax" type="text" value="<?php echo $Contact['fax'] ?>" class="inp-form"  />
		</td>
		<td></td>
		</tr>
         ...
         <tr>
			...
			<td>	
		<input id="email" type="text" value="<?php echo $Contact['email'] ?>" class="inp-form validate[required,custom[email]]"  />
		</td>
		<td></td>
		</tr>
