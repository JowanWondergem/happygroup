...
<tr>
	...
	<td>
        ...
        <?php include_once('../bz/Admins.php');		
			$Admins = Admins::getAdminById($_GET['id']);	
		 ?>
		...
		<tr>
			...
			<td>
                 <select id="active"  class="">
                     <option value="1"   <?php if($Admins['active']==1){ echo 'selected="selected" '; } ?>  >YES</option>
                    <option value="0"   <?php if($Admins['active']==0){ echo 'selected="selected" '; } ?> >NO</option>
		...
		<select id="country" class=" validate[required] " >
            ...
            <?php if( $country['id'] == $Admins['id_country']): ?>
		...
		<td></td>
         ...
         <tr>
			...
			<td>	
		<input id="first_name" type="text" value="<?php echo $Admins['first_name'] ?>" class="inp-form validate[required]"  />
		</td>
		<td></td>
		</tr>
          ...
          <tr>
			...
			<td>	
		<input id="last_name" type="text" value="<?php echo $Admins['last_name'] ?>" class="inp-form validate[required]"  />
		</td>
		<td></td>
		</tr>
         ...
         <tr>
			...
			<td>	
		<input id="address" type="text" value="<?php echo $Admins['address'] ?>" class="inp-form validate[required]"  />
		</td>
		<td></td>
		</tr>
		 <tr>
			...
			<td>	
		<input id="email_private" type="text" value="<?php echo $Admins['email_private'] ?>" class="inp-form validate[required,custom[email]]"  />
		</td>
		<td></td>
		</tr>
        <tr>
			...
			<td>	
		<input id="email_company" type="text" value="<?php echo $Admins['email_company'] ?>" class="inp-form validate[required,custom[email]]"  />
		</td>
		<td></td>
		</tr>
         <tr>
			...
			<td>	
		<input id="phone" type="text" value="<?php echo $Admins['phone'] ?>" class="inp-form validate[required]"  />
		</td>
		<td></td>
		</tr>
         <tr>
			...
			<td>	
		<input id="mobile_phone" type="text" value="<?php echo $Admins['mobile_phone'] ?>" class="inp-form"  />
		</td>
		<td></td>
		</tr>
         ...
         <tr>
			...
			<td>	
		<a href="admins_edit_step1_password.php?id=<?php echo $_GET['id']; ?>"><?php echo $l_form_change ?></a>
		</td>
		<td></td>
		</tr>
...
<script language='javascript'>
					function saveInfo()
					{
						...
						$.ajax
						({
							  url: '../interface/EditAdminInfo.php',
							  type: 'post',
							  dataType: "json",
							  ...
							  success: function(data) 
							  {
								...
								bootbox.alert(data.message, function() {
                					window.location = 'admins_edit_step2.php?id='+'<?php echo $_GET['id'] ?>';
            			});
