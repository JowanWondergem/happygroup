...
<body onLoad="getDes(<?php echo $lang ?>)" > 
...
<div class="navbar">
    <div class="navbar-inner">
    	<a class="brand" href="#"><?php echo $l_newsflash_title ?></a>
    </div>
</div>
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td>
                 <select id="lan" name="lan" class="validate[required] " onChange="getDes(this.value)" >
...
function saveInfo()
{
	...
	$.ajax
	({
		  url: '../interface/EditNewsFlash.php',
		  type: 'post',
		  dataType: "json",
...
function getDes(lan)
{
	...
	$.ajax
	({
		  url: '../interface/getNewsFlash.php',
		  type: 'post',
		  dataType: "html",
