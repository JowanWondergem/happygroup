...
<div id="page-heading"><h1><a href="web_slider_grid.php"><?php echo $l_slider_title_grid ?></a> » <?php echo $l_slider_new ?></h1></div>
...
function saveInfo()
{
	...
	({
		  ...
		  success: function(data) 
		  {
			...
			{
				window.location = 'slider_insert_step2.php?id='+data.id;
			}
			);
