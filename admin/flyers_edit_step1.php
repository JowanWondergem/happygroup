...
<div id="page-heading"><h1><a href="flyers_grid.php"><?php echo $l_flyers_title_grid ?></a> » <?php echo $l_flyers_edit ?></h1></div>
	...
	<td>
		...
		<tr>
			...
			<td>
                 <select id="active"  class="">
                     <option value="1"   <?php if($Flyers['active']==1){ echo 'selected="selected" '; } ?>  >YES</option>
                    <option value="0"   <?php if($Flyers['active']==0){ echo 'selected="selected" '; } ?> >NO</option>
        ...
        <tr>
			...
			<td>
                 <select id="type"  class="validate[required]">
                        ...
                        <option value="area" <?php if($Flyers['id_area']!=0){ echo 'selected="selected" '; } ?> >Region</option>
                        <option value="city" <?php if($Flyers['id_city']!=0){ echo 'selected="selected" '; } ?> >City</option>
                        <option value="theme" <?php if($Flyers['id_theme']!=0){ echo 'selected="selected" '; } ?> >Theme</option>
                </select></td>
			<td></td>
		</tr>
		...
		<select id="theme" class="right validate[required]" >
            ...
            <?php foreach ($Themes as $theme): ?>
                ...
                <?php if( $theme['id'] == $Flyers['id_theme']): ?>
               <option selected="selected" value="<?php echo $theme['id'] ?>" >
...
<script language='javascript'>
					...
					if($("#form").validationEngine('validate'))
						...
						$.ajax
						({
							  url: '../interface/EditFlyerInfo.php',
							  type: 'post',
							  dataType: "json",
