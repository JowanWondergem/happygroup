...
<div id="page-heading"><h1><a href="partners_grid.php"><?php echo $l_cards_title_grid ?></a> » <?php echo $l_cards_new ?></h1></div>
...
<tr>
	...
	<td>
		...
		<td>	
		<input type="text" id="name" name="name" class="inp-form validate[required]" value="" ></input>
		...
		<td>	
		<input type="text" id="subtitle" name="subtitle" class="inp-form validate[required]" value="" ></input>
        ...
        <tr>
		<th valign="top"><?php echo $l_form_duration ?>:</th>
		<td>	
		<input type="text" id="duration" name="duration" class="inp-form validate[required]" value="" ></input>
		...
		<tr>
		<th valign="top"><?php echo $l_form_description ?> :</th>
		<td>	
		<textarea id="description" name="description" class="inp-form validate[required]"></textarea>
...
function saveInfo()
					{
						if($("#form").validationEngine('validate'))
						{
							...
							$.ajax
							({
							  url: '../interface/InsertCardDescription.php',
							  type: 'post',
							  dataType: "json",
							 
							  data: {	
							  			id_card:				window.id_card,					
							  			id_lan:  				$("#lan").val(), 
										name: 					$("#name").val(),
