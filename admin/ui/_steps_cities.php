<div id="step-holder">
			...
			<div class="<?php echo checkStep($step, 1, 'left')?>">
                <a href="<?php echo $section.'_'.$steps[2].'_step1.php?id='.$_GET['id'] ?>">
                <?php echo $l_cities_step1 ?>
                </a>
            </div>
			...
			<div class="<?php echo checkStep($step, 2, 'left')?>">
                <a href="<?php echo $section.'_'.$steps[2].'_step2.php?id='.$_GET['id'] ?>">
                <?php echo $l_cities_step2 ?>
                </a>
            </div>
