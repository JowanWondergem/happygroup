<div id="step-holder">
			...
			if($step!='step1')
			{
				if( $_GET['id']==0)
				{
					header('Location: cards_insert_step1.php?id='.$_GET['id']);
				}
			}
            ...
            <a href="<?php echo 'cards_'.$steps[1].'_step1.php?id='.$_GET['id'] ?>">
            <?php echo $l_cards_step1 ?>
            </a></div>
            ...
            <a href="<?php echo 'cards_'.$steps[1].'_step2.php?id='.$_GET['id'] ?>">
            <?php echo $l_cards_step2 ?>
            </a></div>
            ...
            <a href="<?php echo 'cards_'.$steps[1].'_step3.php?id='.$_GET['id'] ?>">
             <?php echo $l_cards_step3 ?>
            </a></div>
