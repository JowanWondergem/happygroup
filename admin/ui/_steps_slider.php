<div id="step-holder">
            ...
            <a href="<?php echo $section.'_'.$steps[1].'_step1.php?id='.$_GET['id'] ?>"><?php echo $l_slider_step1 ?></a>
            </div>
            ...
            <a href="<?php echo $section.'_'.$steps[1].'_step2.php?id='.$_GET['id'] ?>"><?php echo $l_slider_step2 ?></a>
            </div>
