...
<div id="page-heading"><h1><a href="web_slider_grid.php">Home Page</a> » Add Image</h1></div>
...
<tr>
	...
	<td>
		...
		<?php include_once('../bz/Slider.php');
			...
			$Flyers = Slider::getSliderInfo($_GET['id']);			
		 ?>
		<!-- start id-form -->
...
<input type="hidden" name="folder" value="slider" />
<input type="hidden" name="img_name" value="<?php echo $partner_id;?>" />
<input type="hidden" name="db_table" value="slider" />
<input type="hidden" name="db_field" value="image" />
<input type="hidden" name="mb" value="5" />
<input type="hidden" name="w" value="640" />
<input type="hidden" name="h" value="" />
<label><?php echo $l_slider_image_home ?> <br />rec. (640px X 400px)</label>
<input type="file" name="photoimg" id="photoimg" class="form-file" />
</form>
<div id='preview'>
<?php if($Flyers['image']!=""): ?>
<img src='../media/flyers/<?php echo $Flyers['image'] ?>'  class='preview'>
<?php endif; ?>
</div>
<script type="text/javascript" >
 $(document).ready(function() { 
