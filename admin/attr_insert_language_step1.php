...
<div id="page-heading"><h1><a href="attr_languages_grid.php"><?php echo $l_languages_title_grid ?></a> » <?php echo $l_languages_new?></h1></div>
	...
	<td>
        ...
        <input type="hidden" id="admin_id" value="<?php echo $_SESSION['admin_id'] ?>" />
         ...
         <tr>
			...
			<td>	
            <input id="code" type="text" value="" class="inp-form validate[required,maxSize[2]]"  />
		</td>
		<td></td>
		</tr>
         ...
         <tr>
			...
			<td>	
            <input id="text" type="text" value="" class="inp-form validate[required]"  />
		</td>
		<td></td>
		</tr>
...
<script language='javascript'>
					function saveInfo()
					{
						...
						$.ajax
						({
							  url: '../interface/InsertLanguage.php',
							  type: 'post',
							  dataType: "json",
